...
public static class SameSiteCookiesServiceCollectionExtensions
{
    ...
    private static bool DisallowsSameSiteNone(string userAgent)
    {
        ...
        if (userAgent.Contains("Safari", StringComparison.OrdinalIgnoreCase)
           && userAgent.Contains("Macintosh; Intel Mac OS X 10_14", StringComparison.OrdinalIgnoreCase)
        ...
        if (userAgent.Contains("Chrome/5", StringComparison.OrdinalIgnoreCase) || userAgent.Contains("Chrome/6", StringComparison.OrdinalIgnoreCase))
        {
            return true;
        }
    ...
    private static int GetChromeVersion(string userAgent)
    {
        try
        {
            return Convert.ToInt32(userAgent.Split("Chrome/")[1].Split('.')[0], System.Globalization.CultureInfo.InvariantCulture);
        }
        catch
        {
            return 0;
